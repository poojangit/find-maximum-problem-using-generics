...
class FindMaximumValueTest {
    ...
    public void findMaxIntegerAtFirstPos() {
        int actualValue = FindMaximumValue.findMaximumValueGenericMethod(100, 70, 30);
    ...
    public void findMaxIntegerAtSecondPos() {
        int actualValue = FindMaximumValue.findMaximumValueGenericMethod(100, 700, 30);
    ...
    public void findMaxIntegerAtThirdPos() {
        int actualValue = FindMaximumValue.findMaximumValueGenericMethod(100, 70, 300);
    ...
    public void findMaxFloatAtFirstPos() {
        Float actualValue = FindMaximumValue.findMaximumValueGenericMethod(100.4f, 70.4f, 30.4f);
    ...
    public void findMaxFloatAtSecondPos() {
        Float actualValue = FindMaximumValue.findMaximumValueGenericMethod(100.4f, 700.4f, 30.4f);
    ...
    public void findMaxFloatAtThirdPos() {
        Float actualValue = FindMaximumValue.findMaximumValueGenericMethod(100.4f, 70.4f, 300.4f);
    ...
    public void findMaxStringAtFirstPos() {
        String actualValue = FindMaximumValue.findMaximumValueGenericMethod("Peach","Apple", "Banana");
    ...
    public void findMaxStringAtSecondPos() {
        String actualValue = FindMaximumValue.findMaximumValueGenericMethod("Apple","Peach" ,"Banana");
        String expectedValue = "Peach";
        assertEquals(expectedValue, actualValue, "The maximum value is not correct! The Expected Value is " + expectedValue );
    }
    ...
    public void findMaxStringAtThirdPos() {
        String actualValue = FindMaximumValue.findMaximumValueGenericMethod("Apple","Banana" ,"Peach");
        String expectedValue = "Peach";
        assertEquals(expectedValue, actualValue, "The maximum value is not correct! The Expected Value is " + expectedValue );
    }
